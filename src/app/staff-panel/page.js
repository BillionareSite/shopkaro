    ...
    <main className="min-h-screen bg-[#f6f1ea] text-[#171313]">
      <header className="sticky top-0 z-50 border-b border-[#241a14]/10 bg-[#f6f1ea]/95 backdrop-blur-xl px-5 py-4">
        <div className="mx-auto flex max-w-5xl items-center justify-between">
          ...
          <span className="text-sm text-[#7b6f66] hidden sm:block">Staff Panel</span>
      ...
      <div className="mx-auto max-w-5xl px-5 py-10 pb-16">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
          ...
          <p className="mt-1 text-sm text-[#7b6f66]">
        ...
        {menuItems.length === 0 ? (
          <div className="text-center py-20 rounded-[2rem] border border-[#241a14]/10 bg-white/55">
            ...
            <p className="text-sm text-[#7b6f66]">Contact your master admin to get access</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {menuItems.map((item, i) => (
              <motion.a
                ...
                className={`rounded-[1.4rem] bg-white shadow-lg shadow-[#3d2619]/5 p-6 hover:shadow-xl transition group border ${item.color}`}
              >
                ...
                <p className="text-xs text-[#9b8f86] mt-3">
