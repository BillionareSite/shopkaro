      ...
      <div className="w-full max-w-6xl mx-auto px-4 sm:px-5 py-8 sm:py-10">
        ...
        {cart.length === 0 ? (
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div className="lg:col-span-2 space-y-3">
              {cart.map((item, i) => (
                <motion.div
                  ...
                  className="overflow-hidden rounded-[1.4rem] bg-white shadow-lg shadow-[var(--shadow)]/5 p-4 flex gap-3 sm:gap-4"
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-[var(--text-placeholder)] mb-2">{item.category}</p>
            ...
            {/* Order Summary */}
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="overflow-hidden rounded-[1.4rem] bg-white shadow-lg shadow-[var(--shadow)]/5 p-5 sm:p-6 h-fit lg:sticky lg:top-24">
